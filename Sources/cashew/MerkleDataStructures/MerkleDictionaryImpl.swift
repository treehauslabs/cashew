/// Default concrete implementation of ``MerkleDictionary``.
public struct MerkleDictionaryImpl<Value>: MerkleDictionary, VolumeMerkleDictionary where Value: Codable, Value: Sendable, Value: LosslessStringConvertible {
